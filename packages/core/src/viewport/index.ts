...
import { App, ExampleScenes, Window, WindowGroup, WindowUtils } from './components'
...
export { TachUIViewportManager, getViewportManager, setViewportManager, disposeViewportManager }
...
export const PlatformUtils = {
   ...
   */
  getOptimalWindowType: (preferNative = false): import('./types').ViewportType => {
    const manager = getViewportManager()
