...
export declare class ComponentLifecycleTracker {
     ...
     */
    validateConstruction(component: ComponentInstance, componentType: string, args: unknown[]): void;
    /**
     ...
     */
    validateUpdate(component: ComponentInstance, componentType: string, newProps: any, oldProps: any): void;
    /**
...
export declare const LifecycleValidationUtils: {
    ...
    reset: () => void;
    validateConstruction: (component: ComponentInstance, type: string, args: unknown[]) => void;
    validateMount: (component: ComponentInstance, type: string) => void;
    validateUpdate: (component: ComponentInstance, type: string, newProps: any, oldProps: any) => void;
