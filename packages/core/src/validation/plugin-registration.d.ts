 ...
 */
export declare function registerComponentValidator(validator: ComponentValidator): void;
/**
 * Unregister component validator
 */
export declare function unregisterComponentValidator(packageName: string, componentName: string): void;
/**
 * Get component validator for validation
 */
export declare function getComponentValidator(packageName: string, componentName: string): ComponentValidator | undefined;
/**
 * Register multiple validators from a plugin package
 */
export declare function registerPluginValidation(config: PluginValidationConfig): void;
/**
 ...
 */
export declare function validateComponent(packageName: string, componentName: string, args: unknown[]): void;
/**
 * Check if a component has validation registered
 */
export declare function hasValidator(packageName: string, componentName: string): boolean;
/**
...
export declare const PluginValidationHelper: {
     ...
     */
    registerPlugin(packageName: string, components: Array<{
        name: string;
        requiredProps?: string[];
        optionalProps?: string[];
    }>): void;
     ...
     */
    createValidator(packageName: string, componentName: string, validate: (args: unknown[]) => void): ComponentValidator;
};
