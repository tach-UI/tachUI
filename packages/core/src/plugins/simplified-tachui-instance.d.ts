...
import type { TachUIInstance, TachUIPlugin, ComponentRegistrationOptions } from './simplified-types';
...
export declare function registerComponent(name: string, component: Component, options?: ComponentRegistrationOptions): void;
