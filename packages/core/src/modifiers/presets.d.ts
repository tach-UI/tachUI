/**
 * Pre-built SwiftUI-Style Modifiers
 *
 * Ready-to-use modifier implementations that mirror SwiftUI's modifier API.
 * These provide the core building blocks for layout, appearance, interaction,
...
import type { AnimationModifierProps, AppearanceModifierProps, LayoutModifierProps, Modifier } from './types';
/**
 * Layout Modifiers
 */
export declare const layoutModifiers: {
     ...
     */
    frame(width?: Dimension, height?: Dimension, options?: Omit<LayoutModifierProps["frame"], "width" | "height">): Modifier;
    /**
...
export declare const appearanceModifiers: {
     ...
     * Set border
     */
    border(width: number, color?: string | Asset, style?: "solid" | "dashed" | "dotted"): Modifier;
    /**
...
export declare const animationModifiers: {
     ...
     * Add transition
     */
    transition(property?: string, duration?: number, easing?: string, delay?: number): Modifier;
    /**
     ...
     */
    slideIn(direction?: "up" | "down" | "left" | "right", duration?: number, distance?: number): Modifier;
    /**
     * Add scale animation
     */
...
export declare const presetModifiers: {
     ...
     */
    button(backgroundColor?: string | Asset, textColor?: string | Asset): Modifier[];
    /**
