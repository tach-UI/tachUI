 ...
 */
export declare const COMPONENT_ELIGIBILITY: Map<string, {
 ...
 */
export declare function shouldWarnOnOverride(componentType: string, tag: string): boolean;
/**
...
export declare function configureElementOverrides(config: Partial<ElementOverrideConfig>): void;
 ...
 */
export declare function processElementOverride(componentType: string, defaultTag: string, overrideTag?: string): {
    tag: string;
 ...
 */
export declare function createElementOverrideValidator(componentType: string, defaultTag: string): (overrideTag?: string) => {
    tag: string;
    validation: ValidationResult;
};
