 ...
 */
export declare function lazy<T extends ComponentInstance>(
 ...
 */
export declare function preloadComponent<T>(
  loader: LazyComponentLoader<T>
): Promise<T>
/**
 * Create multiple lazy components with shared preloading
 */
export declare function createLazyComponentGroup<
  T extends Record<string, LazyComponentLoader>,
>(
  loaders: T,
  options?: LazyComponentOptions
): {
 ...
 */
export declare function preloadComponentGroup<
  T extends Record<string, LazyComponentLoader>,
>(
  loaders: T
): Promise<{
...
export declare function createVisibilityLazyComponent<
