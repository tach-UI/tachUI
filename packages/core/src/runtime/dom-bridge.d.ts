 ...
 */
export declare function registerComponentWithLifecycleHooks(
 ...
 */
export declare function mountComponentTree(
  component: ComponentInstance,
  container: Element,
 ...
 */
export declare function unmountComponent(
  component: ComponentInstance,
  container: Element
): void
/**
 ...
 */
export declare function unmountComponentEnhanced(
  component: ComponentInstance,
  container: Element
): void
/**
 ...
 */
export declare function mountComponentChildren(
 ...
 */
export declare function getComponentFromElement(
  element: Element
...
export declare const DOMBridgeDebug: {
  getMountedComponents: () => [
    Element,
    ComponentInstance<import('./types').ComponentProps>,
  ][]
