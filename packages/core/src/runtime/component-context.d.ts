 ...
 */
export declare function setCurrentComponentContext(context: ComponentContext | null): void;
/**
 * Run a function with a specific component context
 */
export declare function runWithComponentContext<T>(context: ComponentContext, fn: () => T): T;
/**
 * Enhanced component wrapper that provides context injection
 */
export declare function withComponentContext<P extends ComponentProps>(component: (props: P) => ComponentInstance<P>, contextId?: string): (props: P) => ComponentInstance<P>;
/**
 ...
 */
export declare function createEnvironmentKey<T>(name: string, defaultValue?: T): EnvironmentKey<T>;
/**
 * Provide environment value
 */
export declare function provideEnvironmentValue<T>(key: EnvironmentKey<T>, value: T): void;
/**
