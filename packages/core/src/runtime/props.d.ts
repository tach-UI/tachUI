 ...
 */
export declare function createPropsManager<P extends ComponentProps>(
  initialProps: P,
 ...
 */
export declare function createChildrenManager(
  initialChildren?: ComponentChildren
): ChildrenManager
/**
 * Create ref manager
 */
export declare function createRefManager<T = any>(
  initialValue?: T | null
): RefManager<T>
/**
...
export declare const propsUtils: {
   ...
   */
  compareProps<P extends ComponentProps>(
    prevProps: P,
    nextProps: P
  ): (keyof P)[]
  /**
   ...
   * Pick specific props
   */
  pickProps<P extends ComponentProps, K extends keyof P>(
    props: P,
    keys: K[]
  ): Pick<P, K>
  /**
   * Omit specific props
   */
  omitProps<P extends ComponentProps, K extends keyof P>(
    props: P,
    keys: K[]
  ): Omit<P, K>
}
