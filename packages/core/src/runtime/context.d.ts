...
export declare class ContextManager {
     ...
     */
    createProvider<T>(context: TachUIContext<T>, value: T, children: ComponentInstance[]): ComponentInstance;
    /**
 ...
 */
export declare function createContext<T>(defaultValue: T, options?: {
    displayName?: string;
}): TachUIContext<T>;
/**
 ...
 */
export declare function withProvider<T, P extends ComponentProps>(context: TachUIContext<T>, value: T): (WrappedComponent: (props: P) => ComponentInstance) => (props: P) => ComponentInstance;
/**
 * Create reactive context consumer
 */
export declare function createContextConsumer<T>(context: TachUIContext<T>, render: (value: T) => ComponentInstance): ComponentInstance;
/**
 ...
 */
export declare function Injectable(key?: symbol | string): <T extends new (...args: any[]) => any>(constructor: T) => T;
/**
 * Context utilities
 */
export declare const contextUtils: {
     ...
     */
    createContextGroup<T extends Record<string, any>>(defaults: T, options?: {
        prefix?: string;
    }): { [K in keyof T]: TachUIContext<T[K]>; };
    /**
     * Combine multiple context providers
     */
    combineProviders<T extends Record<string, any>>(contexts: { [K in keyof T]: TachUIContext<T[K]>; }, values: T, children: ComponentInstance[]): ComponentInstance;
    /**
     * Create context with validation
     */
    createValidatedContext<T>(defaultValue: T, validator: (value: T) => boolean | string, options?: {
        displayName?: string;
    }): TachUIContext<T> & {
