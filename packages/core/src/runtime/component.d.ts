 ...
 */
export declare function withLifecycle<P extends ComponentProps>(
 ...
 */
export declare function createReactiveComponent<P extends ComponentProps>(
  render: (props: P, children?: ComponentChildren) => DOMNode | DOMNode[]
): Component<P>
/**
 * Component error boundary
 */
export declare function createErrorBoundary<P extends ComponentProps>(
 ...
 */
export declare function createAdvancedComponent<P extends ComponentProps>(
  render: (
    props: P,
    children: ComponentChildren,
    helpers: {
 ...
 */
export declare function forwardRef<T, P extends ComponentProps>(
