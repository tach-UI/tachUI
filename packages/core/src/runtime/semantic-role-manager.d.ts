...
export declare class SemanticRoleManager {
     ...
     */
    applySemanticAttributes(element: HTMLElement, tag: string, existingAria?: Record<string, string>): void;
    /**
     ...
     */
    processElementNode(element: HTMLElement, tag: string, componentMetadata?: any, existingAria?: Record<string, string>): void;
}
export declare const semanticRoleManager: SemanticRoleManager;
export declare const applySemanticAttributes: (element: HTMLElement, tag: string, existingAria?: Record<string, string>) => void;
export declare const getSemanticRole: (tag: string) => SemanticRoleInfo | undefined;
