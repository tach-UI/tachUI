...
export declare class FontAsset extends Asset {
    ...
    private loaded;
    private loadPromise;
    constructor(family: string, fallbacks?: string[], name?: string, options?: FontAssetOptions);
    /**
     * Static factory method for SwiftUI-style initialization
     */
    static init(family: string, fallbacks?: string[], name?: string, options?: FontAssetOptions): FontAsset;
    /**
...
export declare const SystemFonts: {
    readonly sansSerif: readonly ["system-ui", "-apple-system", "BlinkMacSystemFont", "Segoe UI", "Roboto", "Helvetica Neue", "Arial", "sans-serif"];
    readonly serif: readonly ["Georgia", "Cambria", "Times New Roman", "Times", "serif"];
    readonly monospace: readonly ["ui-monospace", "SFMono-Regular", "SF Mono", "Consolas", "Liberation Mono", "Menlo", "Courier", "monospace"];
    readonly cursive: readonly ["cursive"];
    readonly fantasy: readonly ["fantasy"];
};
export declare function createSystemFont(type?: keyof typeof SystemFonts, name?: string): FontAsset;
/**
 ...
 */
export declare function createGoogleFont(family: string, weights?: number[], name?: string, options?: Omit<FontAssetOptions, 'fontUrl'>): FontAsset;
export declare function createVariableFont(family: string, fontUrl: string, axes: {
    weight?: [number, number];
    width?: [number, number];
    slant?: [number, number];
    optical?: [number, number];
    custom?: Record<string, [number, number]>;
}, fallbacks?: string[], name?: string): FontAsset;
