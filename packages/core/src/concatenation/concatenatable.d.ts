 ...
 */
export declare abstract class ConcatenatableBase<T = any>
  implements Concatenatable<T>
{
 ...
 */
export declare function makeConcatenatable<T extends ComponentInstance>(
  component: T
): T & Concatenatable
