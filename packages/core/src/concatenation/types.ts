 ...
 */
export type ConcatenationResult<T, U> = 
...
// Forward declaration of ConcatenatedComponent (defined in concatenated-component.ts)
 ...
 */
export function isConcatenatable(obj: any): obj is Concatenatable {
  return obj && typeof obj === 'object' && typeof obj.isConcatenatable === 'function' && obj.isConcatenatable()
}

/**
 * Type guard to check if an object is a concatenated component
 */
export function isConcatenatedComponent(obj: any): obj is ConcatenatedComponent {
  return obj && typeof obj === 'object' && obj.constructor.name === 'ConcatenatedComponent'
}