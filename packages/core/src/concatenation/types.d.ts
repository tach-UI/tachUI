...
export declare class ConcatenatedComponent<_T = any>
  implements ComponentInstance<any>
{
 ...
 */
export declare function isConcatenatedComponent(
  obj: any
): obj is ConcatenatedComponent
