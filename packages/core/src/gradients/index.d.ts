...
export declare function AngularGradient(
  options: AngularGradientOptions
): GradientDefinition
export declare function ConicGradient(
  options: ConicGradientOptions
): GradientDefinition
export declare function RepeatingLinearGradient(
  options: RepeatingLinearGradientOptions
): GradientDefinition
export declare function RepeatingRadialGradient(
  options: RepeatingRadialGradientOptions
): GradientDefinition
export declare function EllipticalGradient(
