...
import type { GradientDefinition, StateGradientOptions, StatefulBackgroundValue } from './types';
/**
...
export declare const ColorUtils: {
     ...
     * Blend two colors
     */
    readonly blendColors: (color1: string, color2: string, ratio?: number) => string;
    /**
...
export declare const GradientTransforms: {
     ...
     */
    readonly rotateLinear: (gradient: GradientDefinition, degrees: number) => GradientDefinition;
    /**
     * Scale radial gradient
     */
    readonly scaleRadial: (gradient: GradientDefinition, scale: number) => GradientDefinition;
    /**
     * Add transparency to entire gradient
     */
    readonly withOpacity: (gradient: GradientDefinition, opacity: number) => GradientDefinition;
    /**
     ...
     */
    readonly toRadial: (gradient: GradientDefinition, radius?: number) => GradientDefinition;
    /**
...
export declare const GradientAnalysis: {
     ...
     */
    readonly getPerformanceImpact: (gradient: GradientDefinition) => "low" | "medium" | "high";
};
/**
...
export declare const GradientGenerators: {
     ...
     */
    readonly monochromatic: (baseColor: string, steps?: number) => GradientDefinition;
    /**
     ...
     */
    readonly complementary: (color1: string, color2?: string) => GradientDefinition;
    /**
...
export declare const StateGradientUtils: {
     ...
     */
    readonly createHoverEffect: (baseGradient: GradientDefinition, intensity?: number) => StateGradientOptions;
    /**
     * Create button gradient states
     */
    readonly createButtonStates: (baseColor: string, type?: "primary" | "secondary" | "danger") => StateGradientOptions;
    /**
...
export declare const CSSUtils: {
     ...
     */
    readonly toCustomProperties: (gradient: GradientDefinition, prefix?: string) => Record<string, string>;
    /**
     * Generate fallback CSS for older browsers
     */
    readonly withFallback: (gradient: GradientDefinition, fallbackColor: string) => string;
    /**
