...
export declare class ReactiveGradientAsset extends AssetClass<string> {
  ...
  constructor(
    name: string,
    reactiveDefinition: ReactiveGradientDefinition,
    updateCallback?: () => void
  )
  /**
...
export declare const ReactiveGradientUtils: {
   ...
   */
  readonly createAnimatedGradient: (
    colors: string[],
    _duration?: number
  ) => ReactiveGradientAsset
  /**
   ...
   */
  readonly createProgressGradient: (
