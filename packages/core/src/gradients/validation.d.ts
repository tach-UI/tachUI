...
import type { GradientDefinition, LinearGradientOptions, RadialGradientOptions, AngularGradientOptions, StateGradientOptions, GradientAnimationOptions, StatefulBackgroundValue, GradientStartPoint, GradientCenter } from './types';
/**
...
export declare const GradientTypeGuards: {
     ...
     */
    readonly isAngularGradient: (value: unknown) => value is GradientDefinition & {
        type: "angular";
    };
    /**
     * Check if value is a state gradient configuration
     */
    readonly isStateGradientOptions: (value: unknown) => value is StateGradientOptions;
    /**
     * Check if value is a stateful background value
     */
    readonly isStatefulBackgroundValue: (value: unknown) => value is StatefulBackgroundValue;
    /**
...
export declare const GradientValidation: {
     ...
     */
    readonly validateStops: (stops: number[], colorsLength: number) => {
        valid: boolean;
        error?: string;
    };
    /**
 ...
 */
export declare const createValidatedGradient: <T extends GradientDefinition>(gradient: T) => ValidatedGradient<T> | never;
export declare const createValidatedStateGradient: (options: StateGradientOptions) => ValidatedStateGradient | never;
/**
