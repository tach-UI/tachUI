 ...
 */
import { createEnvironmentKey, createObservableEnvironmentObject, EnvironmentObject, provideEnvironmentObject } from './environment';
import { makeObservable, observable } from './observed-object';
import { createBinding } from './state';
export { BindingImpl, BindingUtils, createBinding as createEnhancedBinding, isBinding as isEnhancedBinding, } from './binding';
export { CommonEnvironmentKeys, createEnvironmentKey, createObservableEnvironmentObject, EnvironmentObject, isEnvironmentObject, provideEnvironmentObject, } from './environment';
export { createObservableStore, isObservableObject, isObservedObject, makeObservable, ObservableObjectBase, ObservedObjectWrapper as ObservedObject, observable, } from './observed-object';
export { createBinding, createStateBinding, isBinding, isState, State, unwrapValue, } from './state';
export type { Binding, BindingFactory, BindingOptions, BindingValue, ComputedProperty, EnvironmentKey, EnvironmentObject as IEnvironmentObject, EnvironmentObjectFactory, EnvironmentObjectOptions, EnvironmentObjectProvider, ObservableObject, ObservableObjectOptions, ObservedObject as IObservedObject, ObservedObjectFactory, PropertyWrapper, PropertyWrapperMetadata, PropertyWrapperRegistry, State as IState, StateBinding, StateFactory, StateManager, StateWrapperOptions, } from './types';
export declare const createEnvironmentObjectProvider: typeof provideEnvironmentObject;
export declare function useEnvironmentObject(key: any): EnvironmentObject<unknown>;
/**
...
export { createStateManager, getAllStateManagers, getStateManager, getStateManagerDebugInfo, initializeStateDebugging, registerStateManager, StateManagerImpl, unregisterStateManager, } from './state-manager';
/**
