 ...
 * ```
 */
export declare function makeObservable<T extends Record<string, any>>(
  target: T,
...
export declare function observable(
  options?: ObservableObjectOptions
): <T extends new (...args: any[]) => any>(constructor: T) => any
/**
 * Type guard for ObservableObject
 */
export declare function isObservableObject(
  value: any
): value is ObservableObject
/**
 * Type guard for ObservedObject property wrapper
 */
export declare function isObservedObject<T extends ObservableObject>(
  value: any
): value is ObservedObject<T>
/**
 * Utility to create a simple observable store
 */
export declare function createObservableStore<T extends Record<string, any>>(
  initialState: T,
  options?: ObservableObjectOptions
): T & ObservableObject
/**
