 ...
 * ```
 */
export declare function EnvironmentObject<T>(
 ...
 * ```
 */
export declare function provideEnvironmentObject<T>(
  key: EnvironmentKey<T>,
  value: T
): void
/**
 ...
 * ```
 */
export declare function createObservableEnvironmentObject<T extends object>(
 ...
 */
export declare function createEnvironmentObject<T>(
  key: EnvironmentKey<T>,
  value: T
): T
/**
 ...
 */
export declare function isEnvironmentObject<T>(
  value: any
): value is EnvironmentObject<T>
/**
