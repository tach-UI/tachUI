...
import type { Binding, BindingOptions, EnvironmentObject, EnvironmentObjectOptions, ObservableObject, ObservableObjectOptions, ObservedObject, PropertyWrapperRegistry, State, StateManager, StateWrapperOptions } from './types';
/**
...
export declare class StateManagerImpl implements StateManager {
     ...
     */
    registerObservedObject<T extends ObservableObject>(observedObject: ObservedObject<T>, _options?: ObservableObjectOptions): void;
    /**
     * Register an @EnvironmentObject property wrapper
     */
    registerEnvironmentObject<T>(environmentObject: EnvironmentObject<T>, _options: EnvironmentObjectOptions<T>): void;
    /**
 ...
 */
export declare function createStateManager(componentContext: ComponentContext): StateManager;
/**
 * Register a state manager globally
 */
export declare function registerStateManager(componentId: string, manager: StateManager): void;
/**
 ...
 */
export declare function getStateManager(componentId: string): StateManager | undefined;
/**
