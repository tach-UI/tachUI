...
export interface StateManager {
    ...
    registerObservedObject<T extends ObservableObject>(observedObject: ObservedObject<T>, options?: ObservableObjectOptions): void;
    registerEnvironmentObject<T>(environmentObject: EnvironmentObject<T>, options?: EnvironmentObjectOptions<T>): void;
    cleanup(): void;
}
/**
...
export type BindingFactory = <T>(get: Accessor<T>, set: Setter<T>, options?: BindingOptions<T>) => Binding<T>;
export type ObservedObjectFactory = <T extends ObservableObject>(object: T, options?: ObservableObjectOptions) => ObservedObject<T>;
export type EnvironmentObjectFactory = <T>(options: EnvironmentObjectOptions<T>) => EnvironmentObject<T>;
/**
