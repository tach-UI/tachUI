 ...
 * ```
 */
export declare function createRenderEffect<T>(
  fn: EffectFunction<T>,
  options?: EffectOptions
): Effect
/**
 ...
 * @returns The effect computation
 */
export declare function createOnceEffect<T>(
  fn: EffectFunction<T>,
  options?: EffectOptions
): Effect
/**
 ...
 * @returns The effect computation
 */
export declare function createSyncEffect<T>(
  fn: EffectFunction<T>,
  options?: EffectOptions
): Effect
/**
