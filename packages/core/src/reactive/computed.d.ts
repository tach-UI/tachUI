 ...
 * ```
 */
export declare function createComputed<T>(fn: () => T, options?: ComputedOptions<T>): Signal<T>;
/**
 * Create a memo (alias for createComputed for SolidJS compatibility)
 */
export declare function createMemo<T>(fn: () => T, options?: ComputedOptions<T>): Signal<T>;
/**
 ...
 * @returns An accessor function for the computed value
 */
export declare function createDerivedSignal<T>(fn: () => T, deps?: (() => any)[]): Signal<T>;
/**
 ...
 * @returns An accessor function for the computed value
 */
export declare function createConditionalComputed<T>(fn: () => T, when: () => boolean): Signal<T>;
/**
