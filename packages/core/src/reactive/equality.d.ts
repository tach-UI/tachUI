 ...
 */
export declare const createSelectorEquals: <T, K>(selector: (value: T) => K, equalsFn?: EqualityFunction<K>) => EqualityFunction<T>;
/**
 * Create an array equality function with custom element comparison
 */
export declare const createArrayEquals: <T>(elementEquals?: EqualityFunction<T>) => EqualityFunction<T[]>;
/**
 * Create an object equality function with custom property comparison
 */
export declare const createObjectEquals: <T extends Record<string, any>>(propertyEquals?: EqualityFunction<any>) => EqualityFunction<T>;
/**
 * Combine multiple equality functions with AND logic
 */
export declare const combineEquals: <T>(...equalsFunctions: EqualityFunction<T>[]) => EqualityFunction<T>;
/**
 * Utility to wrap an equality function with debugging
 */
export declare const debugEquals: <T>(equalsFn: EqualityFunction<T>, debugName?: string) => EqualityFunction<T>;
