 ...
 */
export declare function createWeakDisposal<T extends object>(target: T, cleanup: CleanupFunction): WeakRef<T>;
/**
 ...
 * @returns Timeout ID
 */
export declare function createTimeout(fn: () => void, delay: number): NodeJS.Timeout;
/**
 ...
 * @returns Interval ID
 */
export declare function createInterval(fn: () => void, delay: number): NodeJS.Timeout;
/**
 ...
 */
export declare function createEventListener<K extends keyof WindowEventMap>(target: Window, event: K, handler: (event: WindowEventMap[K]) => void, options?: AddEventListenerOptions): void;
export declare function createEventListener<K extends keyof DocumentEventMap>(target: Document, event: K, handler: (event: DocumentEventMap[K]) => void, options?: AddEventListenerOptions): void;
export declare function createEventListener<K extends keyof HTMLElementEventMap>(target: HTMLElement, event: K, handler: (event: HTMLElementEventMap[K]) => void, options?: AddEventListenerOptions): void;
