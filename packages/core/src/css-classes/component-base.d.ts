...
export declare abstract class ComponentWithCSSClasses {
     ...
     */
    protected processComponentClasses(props: CSSClassesProps, baseClasses?: string[]): string[];
    /**
     * Create class string for DOM nodes - handles both static and reactive classes
     */
    protected createClassString(props: CSSClassesProps, baseClasses?: string[]): Signal<string> | string;
    /**
     * Create class array for components that need array format
     */
    protected createClassArray(props: CSSClassesProps, baseClasses?: string[]): Signal<string[]> | string[];
    /**
     ...
     */
    protected getClassDebugInfo(props: CSSClassesProps, baseClasses?: string[]): {
        base: string[];
        user: string[];
        processed: string[];
        final: string;
