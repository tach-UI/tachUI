...
- [#402](https://github.com/tach-UI/tachUI/pull/402) [`3c7d240`](https://github.com/tach-UI/tachUI/commit/3c7d24003bac08f32d1131620c5320dea3448d4a) Thanks [@whoughton](https://github.com/whoughton)! - A layout child keeps the effects it was built with, and a mount releases them
  when it unmounts.
...
- [#402](https://github.com/tach-UI/tachUI/pull/402) [`0597547`](https://github.com/tach-UI/tachUI/commit/0597547f699efab16648906a4c8132b02093df36) Thanks [@whoughton](https://github.com/whoughton)! - A delegated event reaches every handler between the target and the container,
...
- [#402](https://github.com/tach-UI/tachUI/pull/402) [`adb81be`](https://github.com/tach-UI/tachUI/commit/adb81be8830ba8de02d4c53d02689ff3a2d97280) Thanks [@whoughton](https://github.com/whoughton)! - A delegated handler reads its own element from `event.currentTarget`.
...
- [#402](https://github.com/tach-UI/tachUI/pull/402) [`0597547`](https://github.com/tach-UI/tachUI/commit/0597547f699efab16648906a4c8132b02093df36) Thanks [@whoughton](https://github.com/whoughton)! - A layout container builds each child once instead of on every render.
...
- [#402](https://github.com/tach-UI/tachUI/pull/402) [`6d787ba`](https://github.com/tach-UI/tachUI/commit/6d787ba6658cc640548133dac94938a1d7d75a49) Thanks [@whoughton](https://github.com/whoughton)! - `renderComponent` builds a component once instead of on every render.
...
- [#409](https://github.com/tach-UI/tachUI/pull/409) [`9d47ded`](https://github.com/tach-UI/tachUI/commit/9d47dedfcffe259abd1d07407512761e29dca0a3) Thanks [@whoughton](https://github.com/whoughton)! - Calling an effect modifier before its package is imported now says which
...
- [#371](https://github.com/tach-UI/tachUI/pull/371) [`23c5c26`](https://github.com/tach-UI/tachUI/commit/23c5c26e90085bb665d3e18b75b5763dbf2709fa) Thanks [@whoughton](https://github.com/whoughton)! - `createSignal` declares the accessor it actually returns. It has always built
...
- [#370](https://github.com/tach-UI/tachUI/pull/370) [`9864d4c`](https://github.com/tach-UI/tachUI/commit/9864d4cab381e92abfc365f7749b9608636e4bb5) Thanks [@whoughton](https://github.com/whoughton)! - `createSignalList` no longer rescans its whole tracked set for every released
...
- [#365](https://github.com/tach-UI/tachUI/pull/365) [`b30f4a3`](https://github.com/tach-UI/tachUI/commit/b30f4a3c80a816398ed644fe2f489c1ca532318b) Thanks [@whoughton](https://github.com/whoughton)! - Re-registering an event handler on an element that has only that one handler no
  longer loses it.
...
- [#365](https://github.com/tach-UI/tachUI/pull/365) [`a2e553b`](https://github.com/tach-UI/tachUI/commit/a2e553b39c649240e5f361c6d925394ccba17d2b) Thanks [@whoughton](https://github.com/whoughton)! - Unmounting a directly mounted tree now releases the renderer bindings its props
  created.
...
- [#365](https://github.com/tach-UI/tachUI/pull/365) [`0c10b49`](https://github.com/tach-UI/tachUI/commit/0c10b4945aefaf290a2779fa44c0a12ff2fc0d8a) Thanks [@whoughton](https://github.com/whoughton)! - A reactive prop re-applied by a re-render now replaces its previous binding
  ...
  the render owner disposed the superseded _effect_, but the closure holding it
...
- [#365](https://github.com/tach-UI/tachUI/pull/365) [`eabe555`](https://github.com/tach-UI/tachUI/commit/eabe55501766e5da320e42e65420dbd64e71e616) Thanks [@whoughton](https://github.com/whoughton)! - A prop that stops being reactive now releases the binding it had.
...
- [#366](https://github.com/tach-UI/tachUI/pull/366) [`b2335fe`](https://github.com/tach-UI/tachUI/commit/b2335fe0c43a9704b6544af48a54071529d2f441) Thanks [@whoughton](https://github.com/whoughton)! - `createSignalList` gains `track(key)`, a stable per-key accessor that answers
