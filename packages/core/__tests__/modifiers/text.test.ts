...
import {
  ...
  overflowWrap,
  hyphens,
} from '@tachui/modifiers/typography/text'
...
describe('Text Modifiers', () => {
    ...
    it('should provide info for large line values', () => {
      ...
      expect(console.info).toHaveBeenCalledWith(
        expect.stringContaining(
          'Large line clamp values (>10) may impact readability'
        )
      )
  ...
  describe('OverflowWrapModifier', () => {
    ...
    it('should handle all valid overflow-wrap values', () => {
      ...
      validValues.forEach(value => {
        const modifier = new OverflowWrapModifier({
          overflowWrap: value as any,
        })
        modifier.apply({} as any, mockContext)
  ...
  describe('Integration Tests', () => {
    ...
    it('should have appropriate priority ordering', () => {
      ...
      const overflowWrapMod = new OverflowWrapModifier({
        overflowWrap: 'normal',
      })
