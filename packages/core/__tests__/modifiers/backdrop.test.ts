...
describe('Unified Backdrop Filter System', () => {
  ...
  describe('BackdropFilterModifier', () => {
    it('should apply backdrop-filter with browser support', () => {
      ...
      expect(mockElement.style.backdropFilter).toBe('blur(10px) brightness(1.1) saturate(1.2)')
      expect(mockElement.style.webkitBackdropFilter).toBe('blur(10px) brightness(1.1) saturate(1.2)')
    })
    ...
    it('should handle CSS string values', () => {
      ...
      expect(mockElement.style.backdropFilter).toBe('blur(15px) saturate(1.5) brightness(1.2)')
      expect(mockElement.style.webkitBackdropFilter).toBe('blur(15px) saturate(1.5) brightness(1.2)')
    })
    ...
    it('should handle drop-shadow with object configuration', () => {
      ...
      expect(mockElement.style.backdropFilter).toBe('drop-shadow(2px 3px 4px rgba(0,0,0,0.3))')
    })
    ...
    it('should handle drop-shadow with string configuration', () => {
      ...
      expect(mockElement.style.backdropFilter).toBe('drop-shadow(0px 4px 8px rgba(0,0,0,0.2))')
    })
    ...
    it('should handle multiple filters in correct order', () => {
      ...
      expect(mockElement.style.backdropFilter).toBe('blur(8px) brightness(1.2) contrast(1.1) hue-rotate(15deg) saturate(1.3)')
    })
    ...
    it('should have correct type and priority', () => {
      const modifier = new BackdropFilterModifier({ backdropFilter: { blur: 10 } })
  ...
  describe('Factory Functions', () => {
    it('should create modifier with backdropFilter function - config object', () => {
      ...
      expect(modifier.properties.backdropFilter).toEqual({ blur: 12, saturate: 1.4 })
    })
    ...
    it('should create modifier with backdropFilter function - CSS string', () => {
      ...
      expect(modifier).toBeInstanceOf(BackdropFilterModifier)
      expect(modifier.properties.backdropFilter).toBe('blur(20px) contrast(1.3)')
    })
  ...
  describe('Glassmorphism Presets', () => {
    const presetTests = [
      { intensity: 'subtle', expectedBlur: 3, expectedSaturate: 1.05, expectedBrightness: 1.05 },
      { intensity: 'light', expectedBlur: 8, expectedSaturate: 1.15, expectedBrightness: 1.1 },
      { intensity: 'medium', expectedBlur: 16, expectedSaturate: 1.3, expectedBrightness: 1.15 },
      { intensity: 'heavy', expectedBlur: 24, expectedSaturate: 1.5, expectedBrightness: 1.2 }
    ] as const

    presetTests.forEach(({ intensity, expectedBlur, expectedSaturate, expectedBrightness }) => {
    ...
    it('should use medium intensity as default', () => {
      ...
      expect(mockElement.style.backdropFilter).toBe('blur(16px) brightness(1.15) saturate(1.3)')
    })
  ...
  describe('Custom Glassmorphism', () => {
    it('should create custom glassmorphism with specified parameters', () => {
      ...
      expect(mockElement.style.backdropFilter).toBe('blur(12px) brightness(1.2) saturate(1.4)')
    })
    ...
    it('should use default saturate and brightness values', () => {
      ...
      expect(mockElement.style.backdropFilter).toBe('blur(15px) brightness(1.1) saturate(1.2)')
    })
  ...
  describe('Integration Tests', () => {
    it('should work in complex glassmorphism design patterns', () => {
      ...
      expect(mockElement.style.backdropFilter).toBe('blur(15px) brightness(1.1) contrast(1.2) drop-shadow(0px 4px 6px rgba(0, 0, 0, 0.1)) saturate(1.8)')
      expect(mockElement.style.webkitBackdropFilter).toBe('blur(15px) brightness(1.1) contrast(1.2) drop-shadow(0px 4px 6px rgba(0, 0, 0, 0.1)) saturate(1.8)')
    })
    ...
    it('should handle all filter types in single modifier', () => {
      ...
      const expected = 'blur(5px) brightness(1.1) contrast(1.2) drop-shadow(2px 2px 4px rgba(0,0,0,0.3)) grayscale(0.1) hue-rotate(15deg) invert(0.05) opacity(0.95) saturate(1.3) sepia(0.1)'
      expect(mockElement.style.backdropFilter).toBe(expected)
    })
  })
})