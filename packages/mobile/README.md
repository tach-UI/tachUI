...
```bash
npm install @tachui/core@0.8.6-alpha @tachui/mobile@0.8.6-alpha
# or
pnpm add @tachui/core@0.8.6-alpha @tachui/mobile@0.8.6-alpha
```
...
**Version 0.8.6-alpha** - Core modal components (ActionSheet, Alert)
...
- **@tachui/core** ^0.8.6-alpha or later
