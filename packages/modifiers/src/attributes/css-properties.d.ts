 ...
 * ```
 */
export declare function customProperties(
 ...
 * ```
 */
export declare function customProperty(
  name: string,
 ...
 * ```
 */
export declare function cssVariables(
 ...
 * ```
 */
export declare function themeColors(
 ...
 * ```
 */
export declare function designTokens(
  tokens: DesignTokens
): CustomPropertiesModifier
