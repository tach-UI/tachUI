/**
 * Enhanced Error System Tests (Migrated from Core)
 *
 * Tests for the improved error messages and developer experience features.
 * Migrated from: /packages/core/__tests__/developer-experience/enhanced-errors.test.ts
 */
...
describe('Enhanced Error System (Migrated)', () => {
  beforeEach(() => {
    // Clear warning cache
  ...
  describe('Type helpers', () => {
    ...
    it('should validate function type', () => {
      ...
      expect(TypeValidation.validateType('not function', 'function')).toBe(
        false
      )
    })
