/**
 * Auto-generated icon set - optimized Lucide icons for intro app
 * Generated at: 2025-08-28T18:15:00.000Z
 * Icons: brain-circuit, replace, plug-zap, swatch-book, panels-top-left, text-cursor-input, book-type, shield-check, siren
 */
import { IconSetRegistry } from '@tachui/symbols'
import type { IconSet, IconDefinition, SymbolVariant } from '@tachui/symbols'

// Extracted icon data from Lucide
...
// Auto-register the generated icon set and make it default
