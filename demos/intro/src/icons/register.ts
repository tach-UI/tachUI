...
class IntroIconSet implements IconSet {
  name = 'intro'
  version = '1.0.0'
  icons = iconData
...
// Register the intro icon set and make it the default
const introIcons = new IntroIconSet()
IconSetRegistry.register(introIcons)
