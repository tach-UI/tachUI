  ...
  return VStack({
    ...
    children: [
      HStack({
        ...
        .modifier.font({ size: 16, weight: 300 })
        .paddingBottom(20)
      ...
      Text(
        "Copyright ©2025 the tachUI team, all rights reserved. Released under ",
      )
        .modifier.font({ size: 16, weight: 300 })
        .paddingBottom(20)
        .build()
        .concat(
          Link("MPL-2.0 License", "https://www.mozilla.org/en-US/MPL/2.0/")
            .modifier.foregroundColor(Assets.accentOrange)
            .textDecoration("underline")
            .build(),
        ),

      Text(
        "SwiftUI is a trademark of Apple Inc. tachUI is not affiliated with, endorsed by, or sponsored by Apple Inc.",
      )
        .modifier.font({ size: 12, weight: 300 })
        .foregroundColor(Assets.white60)
        .build(),
    ],
  })
    .modifier.background(Assets.darkPurple90)
