...
export function Features(): ComponentInstance {
  const items = [
    { icon: 'brain-circuit', title: 'iOS Developer Friendly', description: 'Familiar API patterns with 64+ components and 130+ modifiers. Identical syntax and concepts - iOS developers feel at home immediately with declarative UI patterns. ' },
