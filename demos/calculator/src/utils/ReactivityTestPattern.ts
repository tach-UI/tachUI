  ...
  return VStack({
    ...
    children: [
      Text("Basic Reactivity Test")
        .modifier.fontSize(16).fontWeight(600).build(),
        
      Text(`Count: ${count()}`)
        .modifier.fontSize(14).build(),
    ...
    .modifier.padding(16).backgroundColor("rgba(0,255,0,0.1)").cornerRadius(8).build();
}
...
export function testArrayReactivity(): ComponentInstance {
  ...
  return VStack({
    ...
    .modifier.padding(16).backgroundColor("rgba(0,0,255,0.1)").cornerRadius(8).build();
}
...
export function testScrollViewReactivity(): ComponentInstance {
  ...
  try {
    ...
    scrollViewTest = Text("ScrollView test disabled - causes flatMap error")
      .modifier.padding(8).backgroundColor("rgba(255,0,0,0.2)").build();
  ...
  return VStack({
    ...
    .modifier.padding(16).backgroundColor("rgba(255,255,0,0.1)").cornerRadius(8).build();
}
  ...
  return VStack({
    ...
    children: [
      Text("TachUI Reactivity Test Suite")
        .modifier.fontSize(20).fontWeight(700).textAlign("center").build(),
        
      Text("Use this to verify reactive behavior in any component")
        .modifier.fontSize(14).opacity(0.7).textAlign("center").build(),
