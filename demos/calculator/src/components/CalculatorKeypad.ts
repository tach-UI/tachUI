    ...
    const createButton = (value: CalculatorButtonType, size: string = "1") => {
        ...
        switch (buttonType) {
            ...
            case "operator":
                ...
                bgColor = createComputed(() => isActive() ? Assets.operatorButtonBackgroundActive : Assets.operatorButtonBackground);
                fgColor = createComputed(() => isActive() ? Assets.operatorButtonForegroundActive : Assets.operatorButtonForeground);
                break;
            case "function":
